        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ asset('index.html"><img src="images/logos/logo.png" alt="image') }}"></a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="{{ asset('index.html') }}">Home</a></li>
                        <li><a class="active" href="{{ asset('about-us.blade.html') }}">About us</a></li>
                        <li><a href="{{ asset('contact.html') }}">Contact</a></li> 
                        <li><a href="{{ asset('career.html') }}">Careers</a></li>

                          {{-- <li><a href="{{ asset('services.html') }}">Our Services</a></li>
                        <li><a href="{{ asset('portfolio.html') }}">Portfolio</a></li>
                        <li><a href="{{ asset('features.html') }}">Features</a></li>
